...
project = u"Catsup"
copyright = (
    u'2012-%s, <a href="http://whouz.com">whtsky</a> and'
...
html_sidebars = {
    ...
    "**": ["localtoc.html", "relations.html", "sidebarintro.html", "searchbox.html"],
}
...
latex_documents = [
    ("index", "catsup.tex", u"catsup Documentation", u"whtsky", "manual"),
]
...
man_pages = [("index", "catsup", u"Catsup Documentation", [u"whtsky"], 1)]
